    ...
    return (
        <div className="w-full max-w-md mx-auto p-8 space-y-3 rounded-xl bg-gray-600 text-gray-100 shadow-2xl">
            ...
            <form noValidate="" action="" className="space-y-6">
                ...
                <button className="block w-full p-3 text-center rounded-sm dark:text-gray-50 bg-amber-600">Sign in</button>
            </form>
            ...
            <p className="text-xs text-center sm:px-6 text-gray-100">Don't have an account ?
                <Link to='/auth/logout' rel="noopener noreferrer" className="underline text-lg font-medium text-amber-400"> Register </Link>
            </p>
        </div>
    );
};
