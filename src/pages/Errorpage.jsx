    ...
    return (
        <>
            <div className='py-24 text-center'>
                <h1 className='mb-8 text-5xl font-semibold  text-pink-400'>
                ...
                <Link to='/'>
                <button className="relative inline-flex cursor-pointer items-center justify-center px-7 py-3 text-xl overflow-hidden font-mono font-medium tracking-tighter text-white bg-[#0EA106] rounded-lg group">
