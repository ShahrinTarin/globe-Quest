		...
		<div className='grid  md:grid-cols-2 gap-8 w-11/12 mx-auto mb-10'>
			<div className="w-full p-8 space-y-3 rounded-xl bg-base-100  text-gray-800">
				...
				<form  onSubmit={handleUpdate} className="space-y-10">
					...
					<button className="block w-full p-3 text-center rounded-sm text-gray-50 cursor-pointer bg-amber-600" type='submit'>Update Information</button>
					<Link to='/myprofile' className='flex items-center justify-center'><button className="block cursor-pointer py-3 px-12 text-center rounded-lg text-gray-50 bg-gray-600">Back</button></Link>
				</form>
